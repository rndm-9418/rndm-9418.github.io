...
(function(window, document) {
  ...
  function initialize() {
	 if ($('.sweet-overlay').length>0) return true;
	  
    var sweetHTML = '<div class="sweet-overlay" tabIndex="-1"></div><div class="sweet-alert" tabIndex="-1"><div class="sw_icon error"><span class="x-mark"><span class="line left"></span><span class="line right"></span></span></div><div class="sw_icon warning"> <span class="swal_body"></span> <span class="dot"></span> </div> <div class="sw_icon info"></div> <div class="sw_icon success"> <span class="line tip"></span> <span class="line long"></span> <div class="placeholder"></div> <div class="fix"></div> </div> <div class="sw_icon custom"></div> <h2>Title</h2><p>Text</p><button class="cancel" tabIndex="2">Cancel</button><button class="confirm" tabIndex="1">OK</button></div>',
  ...
  window.sweetAlert = window.swal = function() {
    ...
    switch (typeof arguments[0]) {
      ...
      case 'object':
		...
		params.cancelFunction       = arguments[0].cancelFunction || function(){};
        break;
...
*/
		  if (targetedConfirm && doneFunctionExists && modalIsVisible) {
            ...
            if(params.closeOnConfirm) {
	      	...
	      	if (typeof params.cancelFunction =='function')
  ...
  function setParameters(params) {
    ...
    // Icon
    hide(modal.querySelectorAll('.sw_icon'));
    if (params.type) {
      var validType = false;
      ...
      var $icon = modal.querySelector('.sw_icon.' + params.type);
      show($icon);
      ...
      switch (params.type) {
        ...
        case "warning":
          ...
          addClass($icon.querySelector('.swal_body'), 'pulseWarningIns');
    ...
    // Custom image
    if (params.imageUrl) {
      var $customIcon = modal.querySelector('.sw_icon.custom');
  ...
  function closeModal() {
    ...
    var $successIcon = modal.querySelector('.sw_icon.success');
    removeClass($successIcon, 'animate');
    removeClass($successIcon.querySelector('.tip'), 'animateSuccessTip');
    removeClass($successIcon.querySelector('.long'), 'animateSuccessLong');

    var $errorIcon = modal.querySelector('.sw_icon.error');
    removeClass($errorIcon, 'animateErrorIcon');
    removeClass($errorIcon.querySelector('.x-mark'), 'animateXMark');

    var $warningIcon = modal.querySelector('.sw_icon.warning');
    removeClass($warningIcon, 'pulseWarning');
    removeClass($warningIcon.querySelector('.swal_body'), 'pulseWarningIns');
